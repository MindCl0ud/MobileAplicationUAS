...
import com.example.bersiiiiii.prdctBath
import java.lang.StringBuilder

class MyProductAdapterBath(
    private val context: prdctBath,
    private val list:List<ProductModel>
): RecyclerView.Adapter<MyProductAdapterBath.MyProductViewHolder>(){
