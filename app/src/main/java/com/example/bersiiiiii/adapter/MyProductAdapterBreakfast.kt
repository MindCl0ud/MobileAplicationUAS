...
import com.example.bersiiiiii.prdctBreakfast
import com.example.bersiiiiii.prdctCook
import java.lang.StringBuilder

class MyProductAdapterBreakfast(
    private val context: prdctBreakfast,
    private val list:List<ProductModel>
): RecyclerView.Adapter<MyProductAdapterBreakfast.MyProductViewHolder>(){
