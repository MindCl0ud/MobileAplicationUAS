...
import com.example.bersiiiiii.adapter.MyProductAdapterBaby
...
class  prdctBaby : AppCompatActivity(), IDProductLoadListener {
    ...
    override fun onLoadSuccess(prdctBaby: List<ProductModel>?) {
        val adapter = MyProductAdapterBaby(this,prdctBaby!!)
