...
class  prdctBath : AppCompatActivity(), IDProductLoadListener {
    ...
    override fun onLoadSuccess(prdctBath: List<ProductModel>?) {
        val adapter = MyProductAdapterBath(this,prdctBath!!)
