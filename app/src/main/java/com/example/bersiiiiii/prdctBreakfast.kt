...
import com.example.bersiiiiii.adapter.MyProductAdapterBreakfast
...
class  prdctBreakfast : AppCompatActivity(), IDProductLoadListener {
    ...
    override fun onLoadSuccess(prdctBreakfast: List<ProductModel>?) {
        val adapter = MyProductAdapterBreakfast(context = this, list = prdctBreakfast!!)
